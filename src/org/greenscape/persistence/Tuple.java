...
public interface Tuple {
	 ...
	 *             if tuple element does not correspond to an element in the
	 *             query result tuple
	 */
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             if alias does not correspond to an element in the query
	 *             result tuple or element cannot be assigned to the specified
	 *             type
	 */
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             if i exceeds length of result tuple or element cannot be
