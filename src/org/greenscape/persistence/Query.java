...
public interface Query {
	 ...
	 *             set and only the statement is rolled back
	 * @throws PersistenceException
	 *             if the query execution exceeds the query timeout value set
	 *             and the transaction is rolled back
	 */
	...
	/**
	 * Bind an instance of <code>java.util.Calendar</code> to a
	...
	/**
	 * Bind an instance of <code>java.util.Date</code> to a
	 * <code>Parameter</code> object.
	 * 
	 * @param param
	 *            parameter object
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             if the parameter name does not correspond to a parameter of
	 ...
	 * @throws IllegalArgumentException
	 *             if the parameter name does not correspond to a parameter of
	 *             the query or if the value argument is of incorrect type
	 */
	...
	/**
	 * Bind an instance of <code>java.util.Date</code> to a positional
	 * parameter.
	 * 
	 * @param position
	 *            position
	...
	/**
	 * Get the parameter objects corresponding to the declared parameters of the
	 * query. Returns empty set if the query has no parameters. This method is
	 * not required to be supported for native queries.
	 * 
	 * @return set of the parameter objects
	 * 
	 * @throws IllegalStateException
	 *             if invoked on a native query when the implementation does not
	 *             support this use
	 * @since Java Persistence 2.0
	 */
	...
	/**
	 * Get the parameter object corresponding to the declared parameter of the
	 * given name. This method is not required to be supported for native
	 * queries.
	 * 
	 * @param name
	 *            parameter name
	...
	/**
	 * Get the parameter object corresponding to the declared parameter of the
	 * given name and type. This method is required to be supported for criteria
	 * queries only.
	 * 
	 * @param name
	 *            parameter name
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             if the parameter of the specified name does not exist or is
	 *             not assignable to the type
	 * @throws IllegalStateException
	 *             if invoked on a native query or Java Persistence query
	 *             language query when the implementation does not support this
	 *             use
	 * @since Java Persistence 2.0
	 */
	 ...
	 * parameter with the given position. This method is not required to be
	...
	/**
	 * Get the parameter object corresponding to the declared positional
	 * parameter with the given position and type. This method is not required
	 * to be supported by the provider.
	 * 
	 * @param position
	 *            position
	 * @param type
	 ...
	 * @throws IllegalArgumentException
	 *             if the parameter with the specified position does not exist
	 *             or is not assignable to the type
	 * @throws IllegalStateException
	 *             if invoked on a native query or Java Persistence query
	 *             language query when the implementation does not support this
	 *             use
	...
	/**
	 * Get the flush mode in effect for the query execution. If a flush mode has
	 * not been set for the query object, returns the flush mode in effect for
	 * the entity manager.
	 * 
	 * @return flush mode
	 * 
