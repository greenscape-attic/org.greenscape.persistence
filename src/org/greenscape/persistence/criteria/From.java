...
import org.greenscape.persistence.metamodel.CollectionAttribute;
import org.greenscape.persistence.metamodel.ListAttribute;
import org.greenscape.persistence.metamodel.MapAttribute;
import org.greenscape.persistence.metamodel.SetAttribute;
import org.greenscape.persistence.metamodel.SingularAttribute;
...
public interface From<Z, X> extends Path<X>, FetchParent<Z, X> {
	 ...
	 * method).
	 * 
	 * @return boolean indicating whether the object has been obtained through
	 *         correlation
	 */
	 ...
	 * <code>From</code> object has been obtained through correlation (use of a
	...
	/**
	 * Create a join to the specified single-valued attribute using the given
	 * join type.
	 * 
	 * @param attribute
	 *            target of the join
