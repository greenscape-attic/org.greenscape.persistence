 ...
 * to both top-level queries and subqueries. It is not intended to be used
...
public interface AbstractQuery<T> extends CommonAbstractCriteria {
	...
	/**
	 * Return the query roots. These are the roots that have been defined for
	 * the <code>CriteriaQuery</code> or <code>Subquery</code> itself, including
	 * any subquery roots defined as a result of correlation. Returns empty set
	 * if no roots have been defined. Modifications to the set do not affect the
	 * query.
	 * 
	...
	/**
	 * Return a list of the grouping expressions. Returns empty list if no
	 * grouping expressions have been specified. Modifications to the list do
	 ...
	 * grouping items, or null if no restrictions have been specified.
	 * 
	...
	/**
	 * Return the result type of the query or subquery. If a result type was
	 * specified as an argument to the createQuery or subquery method, that type
	 * will be returned. If the query was created using the createTupleQuery
	 * method, the result type is Tuple. Otherwise, the result type is Object.
	 * 
	 * @return result type
	 */
