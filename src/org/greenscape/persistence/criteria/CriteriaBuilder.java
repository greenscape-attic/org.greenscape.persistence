...
import org.greenscape.persistence.Tuple;

/**
 * Used to construct criteria queries, compound selections, expressions,
 * predicates, orderings.
 * 
 * <p>
 * Note that <code>Predicate</code> is used instead of
 * <code>Expression&#060;Boolean&#062;</code> in this API in order to work
 * around the fact that Java generics are not compatible with varags.
 * 
...
public interface CriteriaBuilder {
	...
	/**
	 * Create a selection item corresponding to a constructor. This method is
	 * used to specify a constructor that will be applied to the results of the
	 * query execution. If the constructor is for an entity class, the resulting
	 * entities will be in the new state after the query is executed.
	 * 
	 * @param resultClass
	...
	/**
	 * Create a some expression over the subquery results. This expression is
	 * equivalent to an <code>any</code> expression.
	 * 
	 * @param subquery
	 *            subquery
	 * 
	...
	/**
	 * Create an any expression over the subquery results. This expression is
	 * equivalent to a <code>some</code> expression.
	 * 
	 * @param subquery
	 *            subquery
	 * 
	 ...
	 * collection. If the collection is empty, the predicate will be false.
	 * 
	 * @param elem
	 *            element expression
	 * @param collection
	 ...
	 * collection. If the collection is empty, the predicate will be true.
	 * 
	 * @param elem
	 *            element expression
	 * @param collection
	 ...
	 * 
	 * A coalesce expression is equivalent to a case expression that returns
	 * null if all its arguments evaluate to null, and the value of its first
	 * non-null argument otherwise.
	 */
