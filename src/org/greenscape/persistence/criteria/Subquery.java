...
/**
 * The <code>Subquery</code> interface defines functionality that is specific to
 * subqueries.
 * 
...
public interface Subquery<T> extends AbstractQuery<T>, Expression<T> {
	/**
	 * Specify the item that is to be returned as the subquery result. Replaces
	 * the previously specified selection, if any.
	 * 
	 * @param expression
	 *            expression specifying the item that is to be returned as the
	 *            subquery result
	 * 
	...
	/**
	 * Create a subquery join object correlated to a join object of the
	 * enclosing query.
	 * 
	 * @param parentJoin
	...
	/**
	 * Create a subquery collection join object correlated to a collection join
	...
	/**
	 * Create a subquery set join object correlated to a set join object of the
	 * enclosing query.
	 * 
	 * @param parentSet
	 *            join object of the containing query
	...
	/**
	 * Create a subquery list join object correlated to a list join object of
	 * the enclosing query.
	 * 
	 * @param parentList
	 *            join object of the containing query
	...
	/**
	 * Create a subquery map join object correlated to a map join object of the
	 * enclosing query.
	 * 
	 * @param parentMap
	 *            join object of the containing query
	...
	/**
	 * Return the query (which must be a CriteriaQuery or a Subquery) of which
	 * this is a subquery.
	 * 
	...
	/**
	 * Return the query (which may be a CriteriaQuery, CriteriaUpdate,
	 * CriteriaDelete, or a Subquery) of which this is a subquery.
	 * 
	 * @return the enclosing query or subquery
	 * 
	...
	/**
	 * Return the correlated joins of the subquery. Returns empty set if the
	 * subquery has no correlated joins. Modifications to the set do not affect
	 * the query.
	 * 
